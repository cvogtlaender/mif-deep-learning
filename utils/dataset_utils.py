...
food_train_ds, food_val_ds = random_split(
    food_training_data, [food_train_size, food_val_size])

food_train_loader = DataLoader(
    food_train_ds, batch_size=food_batch_size, shuffle=True, num_workers=2)
food_val_loader = DataLoader(
    food_val_ds, batch_size=food_batch_size, shuffle=False, num_workers=2)
food_test_loader = DataLoader(
    food_test_data, batch_size=food_batch_size, shuffle=False, num_workers=2)
